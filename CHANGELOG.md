...
- **(factory)** Add doctor, link checker, versioning, presets ([0644506](https://github.com/ydnikolaev/antigravity-factory/commit/0644506b9287a5925b22ec6c5e192ddb8227d54f))

- **(skills)** Add doc-janitor skill for document cleanup ([f0b6f14](https://github.com/ydnikolaev/antigravity-factory/commit/f0b6f143326b6e29abf6eb356b6aaea8f98c02be))

- **(installer)** Integrate afero for gold-standard testable I/O ([a79f1ac](https://github.com/ydnikolaev/antigravity-factory/commit/a79f1ace99456560761dcd7f87be097900d6f610))

- **(skills)** Add refactor-architect skill and /refactor workflow ([e8c8b41](https://github.com/ydnikolaev/antigravity-factory/commit/e8c8b41d070c787542838ef30cbe912291b2f42a))

- **(cli)** Add --force flag to 'skills update' for path rewriting ([2dcb7ee](https://github.com/ydnikolaev/antigravity-factory/commit/2dcb7ee4c2759c13f05e8266dcaf3ef19d8ac206))

- **(cli)** Add verbose logging to updateRules ([6449de6](https://github.com/ydnikolaev/antigravity-factory/commit/6449de68e503554f08315fab35df5e052df8246c))

- Track skill-factory-expert and add Factory Skills section to README ([80b2488](https://github.com/ydnikolaev/antigravity-factory/commit/80b2488c63acbe60cf350eb14d5480c87b96c884))

- **(factory)** Add skill-updater meta-skill ([489598b](https://github.com/ydnikolaev/antigravity-factory/commit/489598b3655bb0cad7cc9ee1dc87ab43c8305525))

- **(factory)** Add meta-skills and automation workflows ([d37020a](https://github.com/ydnikolaev/antigravity-factory/commit/d37020a7bbb1230863b85231d1caf4ce2a5f93f2))

- **(cli)** Add version command ([5aa04e1](https://github.com/ydnikolaev/antigravity-factory/commit/5aa04e1e0434fb34ad577c8adf5d4fed13b86e27))

- **(cli)** Add skills CLI with architecture enforcement ([19a6d62](https://github.com/ydnikolaev/antigravity-factory/commit/19a6d62b7c709122cabdcb245d7bf5d32ddc2560))

- Add project MCP awareness to all skills ([19a970b](https://github.com/ydnikolaev/antigravity-factory/commit/19a970b93c770baf8434da6928d7e43e77d8f661))

- Add project-bro skill and CONFIG.yaml awareness ([f56d7a1](https://github.com/ydnikolaev/antigravity-factory/commit/f56d7a1d61e8c40c79fcdaece1c8b6cf6c66322a))

- Implement explicit Dual-Write Pattern (Iteration Protocol) ([83516f4](https://github.com/ydnikolaev/antigravity-factory/commit/83516f408ab714392ae0a679387911c775eb32ce))

- Implement Artifact Persistence (Dual-Write) pattern ([08da97a](https://github.com/ydnikolaev/antigravity-factory/commit/08da97ac6893e0c2a60fd76fc2770ff901a1b180))

- **(skill-creator)** Add mcp-expert skill and enhance skill-creator workflow ([4c49fa0](https://github.com/ydnikolaev/antigravity-factory/commit/4c49fa0a7f63f41de936e66426197ff479950150))

- Split frontend into generic nuxt + specialized tma-expert ([6adaa82](https://github.com/ydnikolaev/antigravity-factory/commit/6adaa82802a3ff088b7329971badcc9541fd6ac8))

- Add delegation to all skills + pipeline in README ([c481a50](https://github.com/ydnikolaev/antigravity-factory/commit/c481a507c2395ce0894c3930bb65a23b3b0420b2))

- Add delegation guidelines to product/analyst/architect ([e33390a](https://github.com/ydnikolaev/antigravity-factory/commit/e33390a9194e3938398008965994a0ee82f9990b))

- Complete TMA Squad with 10 production-ready skills ([c95b616](https://github.com/ydnikolaev/antigravity-factory/commit/c95b61650720be67f363bdfc48c7942b40d326be))

- Add hello-world example and strict validation ([2f4d2ca](https://github.com/ydnikolaev/antigravity-factory/commit/2f4d2cac124381b6117518e239af8e8f016743ee))

- Add makefile for SSOT installation ([209bd72](https://github.com/ydnikolaev/antigravity-factory/commit/209bd727f0c2383fa404f0dfe81569134b6350c1))

- Initial commit of skill-creator ([e17d293](https://github.com/ydnikolaev/antigravity-factory/commit/e17d293a6b0d5e35faf4d962785295acac89ec55))
...
- **(skills)** Inject Pre-Handoff Validation into all skills ([0a8b2f9](https://github.com/ydnikolaev/antigravity-factory/commit/0a8b2f9c244bd5cfb2f80be542a351b47df4dd4b))

- **(skills)** Pipeline hardening rollout ([f6ebf48](https://github.com/ydnikolaev/antigravity-factory/commit/f6ebf4883ba564d9b5ca4a7f6406c50424b0fdf0))

- **(installer)** Add tests + fix MCP examples build ([0af3984](https://github.com/ydnikolaev/antigravity-factory/commit/0af3984a534f9805b60c92495b8a1f8a659760fd))

- **(installer)** Split god-file + add tests + enforce lint ([d464e8a](https://github.com/ydnikolaev/antigravity-factory/commit/d464e8a40f200f8204e6025886ddba7d6a3ee624))

- **(workflow)** Update /push to merge locally instead of PR ([7b07587](https://github.com/ydnikolaev/antigravity-factory/commit/7b0758709ac714aafc0242f9fed4bd81f7fb8388))

- Separate factory (.agent/skills) from products (squads/) ([b810622](https://github.com/ydnikolaev/antigravity-factory/commit/b81062214824da3e6ca35773d28a0a4f5a760090))
...
- **(readme)** Add coverage badge (95.9%) ([98c4859](https://github.com/ydnikolaev/antigravity-factory/commit/98c4859d32be53f89aad2cbacba8264c94f5fe54))

- **(agents)** Add afero integration and 95% coverage enforcement info ([99ea01a](https://github.com/ydnikolaev/antigravity-factory/commit/99ea01a367427dcffcc4b57e7ecd925e010c8d6b))

- Update skill-factory-expert with skill-updater and new standards ([5317e53](https://github.com/ydnikolaev/antigravity-factory/commit/5317e534e8b561dc23baeb12ee23f9df8aa0379b))

- Add skill-updater and Tech Debt Protocol to CHANGELOG ([e1fd3f7](https://github.com/ydnikolaev/antigravity-factory/commit/e1fd3f7d981d5226bd745faeb7e0dfd32a03d669))

- Update project docs with factory skills and workflows ([729668b](https://github.com/ydnikolaev/antigravity-factory/commit/729668b92a4fdaf2cf003d8426169588bfb74db3))

- Update README with skills CLI documentation ([7cd2d7c](https://github.com/ydnikolaev/antigravity-factory/commit/7cd2d7c521b416244b9c7c27c3ed22178bacb025))

- Enforce 'Draft -> Approved' status change and explicit Dual-Write explanation in all skills ([22d207f](https://github.com/ydnikolaev/antigravity-factory/commit/22d207f9d8b32eccb644ac17cb6e3157fcf0b5f9))

- Clean README from squad-specific content ([3142978](https://github.com/ydnikolaev/antigravity-factory/commit/31429782831b09b541af0878d76e62f83023e36d))

- Update readme with gold standard and validation features ([bdabfd2](https://github.com/ydnikolaev/antigravity-factory/commit/bdabfd2697ef1ad81f358bda703de8ab9045b0cc))
...
- **(cli)** Use copyDirWithRewrite in showChangesAndApply ([0c42302](https://github.com/ydnikolaev/antigravity-factory/commit/0c423026353acf0c7e6ee85b51aa5599b1bae1c2))

- **(cli)** Rewrite _standards/ paths to .agent/rules/ during install/update ([8d23f88](https://github.com/ydnikolaev/antigravity-factory/commit/8d23f8873882206b605aeb5cb9af45c26f1aeff8))

- **(cli)** Add rules sync to 'skills update' command ([4903eac](https://github.com/ydnikolaev/antigravity-factory/commit/4903eacbcacadefa39c2838fc66cab52ccc28950))

- **(workflow)** Embed self-evolve checks in /commit workflow ([c49bfb2](https://github.com/ydnikolaev/antigravity-factory/commit/c49bfb2b9d9c884c59fdc2b48fadc7e932e81992))

- Add Dual-Write Pattern sections to feature-fit skill ([374a301](https://github.com/ydnikolaev/antigravity-factory/commit/374a301220c238ff9193920d5049f84386721b1c))

- **(cli)** Remove global path sync from skills install ([06b6a8b](https://github.com/ydnikolaev/antigravity-factory/commit/06b6a8be9e86b1ac31c4d19abbc09adb17a32183))

- Update global skills path from skills/ to global_skills/ ([4db4134](https://github.com/ydnikolaev/antigravity-factory/commit/4db4134c2e1159b8c4100791cbd6e7b2f2885d0e))

- Use physical copy instead of symlinks for skill installation ([e10e55a](https://github.com/ydnikolaev/antigravity-factory/commit/e10e55a33a70a1db5fd9a3fd4090c3759f076ed4))

- Improve context7 queries in bmad-architect ([23d604b](https://github.com/ydnikolaev/antigravity-factory/commit/23d604bae497e4c0b8b346893bcb628ac5902048))
...
- **(team)** Add doc-janitor to roster (21 skills) ([e853fd3](https://github.com/ydnikolaev/antigravity-factory/commit/e853fd3c1c198c7ccdb6a2406a7e20bf6ec833a9))

- **(factory)** Self-evolve skill-factory-expert (19→20 skills) ([34cdc16](https://github.com/ydnikolaev/antigravity-factory/commit/34cdc169d7ae1e76605fb8a3d924f792d004781f))
