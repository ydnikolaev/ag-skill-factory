...
| Purpose | Path |
|---------|------|
| Entry point | `src/_meta/schema/skills/AGENTS.md` |
| Core schema | `src/_meta/schema/skills/skill-schema.yaml` |
| Factory enums | `src/_meta/schema/skills/enums/factory.yaml` |
| Runtime enums | `src/_meta/schema/skills/enums/runtime.yaml` |
| Template | `src/_meta/schema/skills/examples/_template.yaml` |
...
1. Read `src/_meta/schema/skills/AGENTS.md`
...
1. Copy `src/_meta/schema/skills/examples/_template.yaml` to `src/skills/{name}/skill.yaml`
2. Set `name` — lowercase-with-hyphens, unique
3. Write `description`:
   - First sentence: WHAT it does
   - Second sentence: WHEN to use it
4. Set `phase` — from `src/_meta/schema/skills/enums/factory.yaml#phases`
5. Set `category` — from `src/_meta/schema/skills/enums/factory.yaml#categories`
...
1. Set `protocols` — from `src/_meta/schema/skills/enums/runtime.yaml#protocols`
2. Set `checks` — from `src/_meta/schema/skills/enums/runtime.yaml#checks`
